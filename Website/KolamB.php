...
<body id="page-top">
      ...
      <div id="content">
		...
		<div class="card-deck">
			<div class="card text-white bg-success mb-3" style="max-width: 14rem;">
			  <div class="card-header bg-success">Jenis Udang</div>
			  <div class="card-body">
				<h5 class="card-text"><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
			...
			<div class="card text-white bg-success mb-3" style="max-width: 15rem;">
			  <div class="card-header bg-success">Tanggal Pembelian</div>
			  <div class="card-body">
				<h5 class="card-text"><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
											while($data = mysqli_fetch_array($query))
											echo $data['pembelian'];
			...
			<div class="card text-white bg-success mb-3" style="max-width: 9rem;">
			  <div class="card-header bg-success">Jumlah Bibit</div>
			  <div class="card-body">
				<h5 class="card-text"><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
											while($data = mysqli_fetch_array($query))
			...
			<div class="card text-white bg-success mb-3" style="max-width: 12rem;">
			  <div class="card-header bg-success">Prediksi Panen</div>
			  <div class="card-body">
				<h5 class="card-text"><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
											while($data = mysqli_fetch_array($query))
			...
			<div class="card text-white bg-success mb-3" style="max-width: 13rem;">
			  <div class="card-header bg-success">Jumlah Produksi Panen</div>
			  <div class="card-body">
				<h5 class="card-text"><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
											while($data = mysqli_fetch_array($query))
  ...
  <script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
	...
	ctx.height=100;
		...
		function grapik(){
			$.get('PHapi_grap.php?id=2',function(data){
