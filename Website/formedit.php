  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		$query = mysqli_query($conn,"select * from kolam where idkolam='$id'");
		   ...
		   <form method="post" action="update.php">
			<table>
				<tr>			
					<td>Nama Kolam</td>
					<td>
						<input type="hidden" name="id" value="<?php echo $d['idkolam']; ?>">
						<input type="text" name="namakolam" value="<?php echo $d['kolam']; ?>">
					</td>
				</tr>
				<tr>
					<td>Luas Kolam</td>
					<td><input type="text" name="luaskolam" value="<?php echo $d['luas']; ?>"></td>
				</tr>
				<tr>
					<td>Kedalaman Kolam</td>
					<td><input type="number" min="0" name="dalamkolam" value="<?php echo $d['kedalaman']; ?>"></td>
				</tr>
				<tr>
					<td>Jenis Udang</td>
					<td><input type="text" name="jenisudang" value="<?php echo $d['jenis']; ?>"></td>
				</tr>
				<tr>
					<td>Tanggal Pembelian</td>
					<td><input type="date" name="tglbeli" value="<?php echo $d['pembelian']; ?>"></td>
				</tr>
				<tr>
					<td>Jumlah Bibit</td>
					<td><input type="number" min="0" name="bibit" value="<?php echo $d['jumlahbibit']; ?>"></td>
				</tr>
				<tr>
					<td>Prediksi Panen</td>
					<td><input type="date" name="tglpanen" value="<?php echo $d['prediksipanen']; ?>"></td>
				</tr>
				<tr>
					<td>Perkiraan Panen</td>
					<td><input type="number" min="0" name="panen" value="<?php echo $d['jumlahpanen']; ?>"></td>
				</tr>
				<tr>
					<td></td>
