		...
		<table class="table">
		  <thead class="thead-dark">
			<tr>
			  ...
			  <th scope="col">Prediksi Panen</th>
		  ...
		  <tbody>
			<?php 
					$no = 1;
					$query = mysqli_query($conn,'SELECT * FROM kolam order by idkolam ASC');
					 ?>
                    
                    <?php while($d = mysqli_fetch_array($query)){ ?>
                    <tr>
                      <td class="table-danger"><?php echo $no++; ?></td>
                      <td class="table-danger"><?php echo $d['kolam']; ?></td>
                      <td class="table-danger"><?php echo $d['luas']; ?></td>
                      <td class="table-danger"><?php echo $d['kedalaman']; ?></td>
					  <td class="table-danger"><?php echo $d['jenis']; ?></td>
					  <td class="table-danger"><?php echo $d['pembelian']; ?></td>
					  <td class="table-danger"><?php echo $d['jumlahbibit']; ?></td>
					  <td class="table-danger"><?php echo $d['prediksipanen']; ?></td>
					  <td class="table-danger"><?php echo $d['jumlahpanen']; ?></td>
                      <td class="table-danger">
						<a href="formedit.php?id=<?php echo $d['idkolam']; ?>" class="btn btn-primary">Edit</a>
                      </td>
                    </tr>
                    <?php } ?>
		  </tbody>
