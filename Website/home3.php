    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="card-deck">
			...
			<div class="card-header bg-secondary mb-3">Kolam A</div>
				<div class="card-body">
					...
					<tr>
						...
						<th scope="col">Masa(Umur)</th>
					</tr>
					</thead>
					
					<tbody>
					<tr>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM ph WHERE idkolam=1 order by id DESC LIMIT 1');
											while($data = mysqli_fetch_array($query))
											echo $data['ph'];
										?></td>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=1');
											while($data = mysqli_fetch_array($query))
			...
			<div class="card-header bg-danger mb-3">Kolam B</div>
				<div class="card-body">
				<table class="table table-secondary">
					<thead>
					<tr>
					...
					<tbody>
					<tr>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM ph WHERE idkolam=2 ORDER BY id DESC LIMIT 1');
											while($data = mysqli_fetch_array($query))
											echo $data['ph'];
										?></td>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=2');
											while($data = mysqli_fetch_array($query))
											echo $data['jumlahbibit'];
										?></td>
						<td>90 hari</td>
			...
			<div class="card-header bg-info mb-3">Kolam C</div>
				<div class="card-body">
				<table class="table table-secondary">
					<thead>
					<tr>
					...
					<tbody>
					<tr>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM ph WHERE idkolam=3 ORDER BY id DESC LIMIT 1');
											while($data = mysqli_fetch_array($query))
											echo $data['ph'];
										?></td>
						<td><?php $query = mysqli_query($conn,'SELECT * FROM kolam where idkolam=3');
											while($data = mysqli_fetch_array($query))
											echo $data['jumlahbibit'];
										?></td>
						<td>0 hari</td>
